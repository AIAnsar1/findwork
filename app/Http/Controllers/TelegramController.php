    ...
    public function showLangStart(Nutgram $bot, TelegramUser $user)
    {
        $keyboard = InlineKeyboardMarkup::make()
            ->addRow(
                ...
                $u = $user->username ?: ($user->first_name ?: __('messages.friend', [], $this->tgLang($bot)));

        

                $text = __('messages.language.select', ['name' => $u], $this->tgLang($bot));
...

            {
                ...
                $text = __('messages.language.select_multilang', ['name' => $u]);
...

            {
                ...
                if (!$user) {
                    ...
                    $bot->sendMessage(__('messages.errors.user_not_found', [], $this->tgLang($bot)));
                ...
                if (in_array($callbackData, $actions)) {
                    ...
                    if ($callbackData === "resume:create") {
                        ...
                        return $this->resumeListsService->handle($bot, $user, $callbackData, $messageId);

                    } elseif ($callbackData === "vacancy:edit") {

                        return $this->vacancyListService->handle($bot, $user, $callbackData, $messageId);
...

            {
                ...
                if (!$user) {
                    ...
                    $bot->answerCallbackQuery(text: __('messages.errors.user_not_found', [], $lang));
                ...
                if ($callbackData === 'save:resume') {
                    ...
                    if ($bot->getUserData('editing_resume_id')) {

                        $this->resumeListsService->handle($bot, $user, $callbackData, $messageId);
                ...
                if ($callbackData === 'save:vacancy') {
                    ...
                    if ($bot->getUserData('editing_vacancy_id')) {

                        $this->vacancyListService->handle($bot, $user, $callbackData, $messageId);
                ...
                $bot->answerCallbackQuery(text: __('messages.errors.unknown_command', [], $lang));
...

            {
                ...
                if (count($parts) !== 3) {
                    ...
                    $bot->answerCallbackQuery(text: __('messages.errors.invalid_callback', [], $lang));
...

            {
                ...
                if ($model) {
                    ...
                    $bot->sendMessage(
                        ...
                        __('messages.moderation.rejected_user_notification', ['reason' => $reason], $lang), 
                    ...
                    $bot->editMessageText(
                        ...
                        __('messages.moderation.rejected_admin_notification', ['reason' => $reason], $lang), 
